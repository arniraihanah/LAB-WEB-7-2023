...
<head>
  ...
  <title>@yield('title') | learnCrafter</title>
...
<body class="antialiased flex flex-col items-center">
  ...
  <header class="flex justify-between items-center px-8 py-3 w-full border-b border-b-slate-300 bg-white sticky top-0 z-10">
    ...
    <div class="flex space-x-4 items-center">
      ...
      <a href="{{ route('auth.logout') }}" class="min-w-[6rem] text-center px-3 py-2 rounded-md bg-emerald-700 hover:bg-emerald-800 active:bg-emerald-900 text-white">Logout</a>
    </div>
  </header>
  @yield('content')
</body>
