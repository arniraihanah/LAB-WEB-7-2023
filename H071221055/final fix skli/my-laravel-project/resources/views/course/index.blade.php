...
<main class="w-full flex flex-col space-y-6 px-8 py-4">
  <div class="w-full flex">
    ...
    <a href="{{ route('course.create_view') }}" class="text-center px-3 py-2 rounded-md bg-emerald-700 hover:bg-emerald-800 active:bg-emerald-900 text-white ml-auto">Add Course</a>
  </div>
