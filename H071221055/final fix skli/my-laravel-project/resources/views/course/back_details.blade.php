...
{{-- TAMBAH CONTENT --}}
  <div class="w-full flex flex-col space-y-8">
    <div class="w-full flex items-center">
      ...
      @if($course->mode == 'edit')
      <a href="{{ route('course.create_content_view', [ 'id' => $course->id ]) }}" class="text-center px-3 py-2 rounded-md bg-emerald-700 hover:bg-emerald-800 active:bg-emerald-900 text-white ml-auto">Create Content</a>
      @endif
    </div>
