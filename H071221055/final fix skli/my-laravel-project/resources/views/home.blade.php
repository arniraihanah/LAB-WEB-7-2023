    ...
    <div class="w-full flex flex-wrap gap-6">
      ...
      <div class="border border-slate-300 rounded-md flex flex-col min-h-[22rem] w-96 max-w-xs">
        ...
        <div class="flex flex-col justify-between p-4 h-[10.75rem]">
          ...
          <a href="{{ route('course.details', [ 'id' => $enrolled_course->id ]) }}" class="text-center px-3 py-2 rounded-md bg-emerald-700 hover:bg-emerald-800 active:bg-emerald-900 text-white cursor-pointer">Open Course</a>
        </div>
      </div>
      @endforeach
    </div>
